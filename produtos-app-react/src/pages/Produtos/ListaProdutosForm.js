...
var ListaProdutosForm = React.createClass({
...
<div id="produtos-body">
		...
		<div id="div-left" >
					...
					<BootstrapTable data={this.state.data} 
						...
						<TableHeaderColumn dataField="id" isKey={true} dataAlign="center" dataSort={true}>Produto ID</TableHeaderColumn>
					...
					<AdicionaProdutoModal parent={this} ref="adicionaProduto" />

					<AtualizaProdutoModal parent={this} ref="atualizaProduto"/>
		</div>
...
export default ListaProdutosForm;